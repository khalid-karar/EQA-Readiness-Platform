...
- [ ] Remove `/dashboard` and `/remediation` from the public-route allowlist (`packages/tenant/src/public-routes.ts`) and require authenticated tenant-bound access before any real client data is shown.
